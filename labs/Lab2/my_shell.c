...
*/
void pipe_implementation(char * cmd0,char * cmd1,char * cmd2,char *
cmd3){
...
fileline[strlen(fileline) - 1] = '\0';
 ...
 // printf("Command %s does not exist currently in our
shell \n",line);
...
pipe_implementation(tokens[0],tokens[1],tokens[3],tokens[4]);
 ...
 if(!flag){
 printf("Command %s does not exist currently in
our shell \n",tokens[0]);
 }
 continue;
 }
